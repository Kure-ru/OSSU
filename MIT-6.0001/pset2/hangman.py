...
def hangman(secret_word):
    ...
    while guess_num > 0:
        # Print number of warning and guesses left
        print(f"You have {warning_num} warnings left")
        ...
        if not letter.isalpha() and len(letter) != 1:
          print(f"Oops! That is not a valid letter. You have {warning_num} left: {get_guessed_word(secret_word, letters_guessed)}  ")
          if warning_num > 0:
            warning_num -= 1
          else:
              guess_num -= 1
        elif letter in letters_guessed:
          print(f"Oops! You've already guessed that letter. You now have {warning_num} warnings:")
          if warning_num > 0:
            warning_num -= 1
          else:
              guess_num -= 1
        ...
        if is_word_guessed(secret_word, letters_guessed):
            ...
            total_score = guess_num * len(secret_word)
...
def match_with_gaps(my_word, other_word):
    ...
    for my_letter in my_word:
        for other_letter in other_word:
            if my_letter == other_letter or my_letter == '_':
                return True
    else:
        return False
