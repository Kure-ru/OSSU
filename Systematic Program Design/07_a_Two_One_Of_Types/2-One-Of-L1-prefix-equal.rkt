...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname 2-One-Of-L1-prefix-equal) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; produce true is lsta is a prefix of lstb
