...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Compound-P1-movie) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;;Movie Movie -> String
;;Compare two movies and produce the movie title of the most recently released
(check-expect (most-recent-movie M1 M2) "Avatar")
(check-expect (most-recent-movie M3 M2) "The Avengers")

;(define (most-recent-movie m1 m2) "") ;stub
