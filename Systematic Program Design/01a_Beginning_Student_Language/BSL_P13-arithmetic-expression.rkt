...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname BSL_P13-arithmetic-expression) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
