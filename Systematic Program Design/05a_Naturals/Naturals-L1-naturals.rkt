...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname L1-naturals) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
