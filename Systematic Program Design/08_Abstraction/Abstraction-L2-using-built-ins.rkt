...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Abstraction-L2-using-built-ins) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (sum lon) (foldr + 0 lon)) ;stub
