...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Abstraction-P5-ellipses) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(local [(define (produce-ellipse n) (ellipse n (* 2 n) "solid" "blue"))]
  (build-list 20 produce-ellipse))
...
(local [(define (produce-group-ellipses n) (ellipse n (* 2 n) "solid" "blue"))]
        (foldr beside BLANK (build-list 20 produce-group-ellipses)))
...
(local [(define (produce-group-ellipses n) (ellipse n (* 2 n) "solid" "blue"))]
        (foldl beside BLANK (build-list 20 produce-group-ellipses)))