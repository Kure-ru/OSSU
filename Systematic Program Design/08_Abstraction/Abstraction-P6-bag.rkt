...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Abstraction-P6-bag) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (linear-length-lob LOB2) (list 36.0 41.5 33.0)) 
