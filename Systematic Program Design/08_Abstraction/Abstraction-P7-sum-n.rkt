...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Abstraction-P7-sum-n) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
