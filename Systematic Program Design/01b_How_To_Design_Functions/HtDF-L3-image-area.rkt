...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname HtDF-L3-image-area) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
