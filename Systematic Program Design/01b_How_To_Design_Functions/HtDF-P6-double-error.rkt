...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname HtDF-P6-double-error) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
