...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Accumulators-P12-contains-key) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
