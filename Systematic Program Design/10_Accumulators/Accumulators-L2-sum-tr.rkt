...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Accumulators-L2-sum-tr) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
