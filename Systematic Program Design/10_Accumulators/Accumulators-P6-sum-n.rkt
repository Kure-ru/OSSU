...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Accumulators-P6-sum-n) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
