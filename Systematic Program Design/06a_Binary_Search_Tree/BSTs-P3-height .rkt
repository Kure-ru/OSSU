...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |BSTs-P3-height |) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; BST -> Number
;; consumes a BST and produces its height; false = 0
