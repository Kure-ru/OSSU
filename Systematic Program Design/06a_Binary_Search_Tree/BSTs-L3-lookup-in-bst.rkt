...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname BSTs-L3-lookup-in-bst) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
