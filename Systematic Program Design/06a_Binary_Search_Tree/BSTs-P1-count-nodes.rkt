...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname BSTs-P1-count-nodes) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; BST -> Natural
;; count the number of nodes of a given BST; if BST is false return 0
