...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname |Mutual-Ref-L1-fs |) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;; produce a list of the names of all elements
...
(check-expect (list-names--element D6) (cons "D6" (append (list "D4" "F1" "F2") (list "D5" "F3"))))
