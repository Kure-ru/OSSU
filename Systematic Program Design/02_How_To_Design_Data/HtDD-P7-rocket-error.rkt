...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname HtDD-P7-rocket-error) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
