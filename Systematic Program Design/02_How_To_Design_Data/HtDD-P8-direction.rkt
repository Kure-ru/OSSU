...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname HtDD-P8-direction) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
