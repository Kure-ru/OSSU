...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Graphs-P2-count-rooms) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
