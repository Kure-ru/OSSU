...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Graphs-L1-graphs) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; template: structural resursion, encapsulate w/ local, tail-recursive w/ worklist,
...
;; Room String -> Boolean
;; produce true if starting at r0 is possible to reach a room named rn
