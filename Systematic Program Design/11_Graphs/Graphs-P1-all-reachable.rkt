...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Graphs-P1-all-reachable) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; Room -> (listof String)
;;consumes a room and produces a list of the names of all the rooms reachable from that room.
