...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname Local-P4-encapsulate-total-area) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
